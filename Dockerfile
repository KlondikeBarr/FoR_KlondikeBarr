...
COPY miniproject2 custom_ws/src/
# COPY klondikebarr.yaml /data/config/calibrations/kinematics/klondikebarr.yaml
RUN chmod +x custom_ws/src/miniproject2/src/pid.py
